				...
				<div className={'auxPage'}>
					...
					<div className={'paragraphBlock'}>
						...
						<p className={'paragraph'}>I spent a year working in 2020 during COVID working at a company called <b>Leigo Industries</b> where most of the time was spent developing
							my skills using <b>ReactJS and MobX</b> working on client projects and internal projects.
						</p>
						<p className={'paragraph'}>
							I have since left the company due to financial issues but 2020 has taught me how to build user interfaces, websites and admin panels.
						</p>
						<p className={'paragraph'}>
							I have also other skills besides the Javascript/ReactJS/MobX, in Java and C++ as those were fundamentals taught at University.
							My main focus is on Javascript and Web Development for the front end with user interfaces and usability in mind,
						...
						<p className={'paragraph'}>
							I have been filming video and taking photos since 2016 and have gather skills and gear throughout the years through self learning via the internet
							and experimenting. I have also self taught myself video editing in <b>Adobe Premiere Pro</b> and <b>Adobe After Effects</b> putting together cinematic
